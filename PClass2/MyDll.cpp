...
//Date class
	...
	void Date::setDate(int SDay, int SMonth, int SYear){
			...
			if(SMonth > 0 && SMonth <= 12){
				...
				case 12:
					if(SDay > 0 && SDay <=31){
						...
						cout << "Error, days cannot be negative or more than 31 in the specified month!\n";
					break;
				case 4:
				case 6:
				case 9:
				case 11:
					if(SDay > 0 && SDay <= 30){
						...
						cout << "Error, days cannot be negative or more than 30 in the specified month!\n";
					break;
				case 2:
					...
					if(SDay > 0 && SDay <= 29){
						...
						cout << "Error, days cannot be negative or more than 29 in the specified month!\n";
					} else{
						if(SDay > 0 && SDay <= 28){
							Day = SDay;
							Month = SMonth;
							...
							cout << "Error, days cannot be negative or more than 28 in the specified month!\n";
					}
					break;
				}
			} else
				cout << "Error, month cannot be negative or more than 12!\n";
		} else
	...
	void Date::setDate(string FullDate){
